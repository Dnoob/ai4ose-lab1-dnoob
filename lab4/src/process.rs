...
pub struct Process {
    ...
    // =================================================================
    // TODO 0：添加 syscall_counts 字段
    // =================================================================
    // 需求：添加一个字段来记录每个系统调用的调用次数
    //
    // 提示：
    //   - 系统调用编号范围是 0~511，需要 512 个计数器
    //   - 类型建议：Vec<u32>
    //   - 同时需要在下方 Process::new() 的返回值中初始化它
    // =================================================================
}
    ...
    pub fn new(elf: ElfFile) -> Option<Self> {
        ...
        *context.sp_mut() = 1 << 38;
        Some(Self {
            ...
            // =============================================================
            // TODO 0：初始化 syscall_counts
            // =============================================================
            // 提示：用 vec! 宏创建一个长度为 512、初始值为 0 的 Vec<u32>
            // =============================================================
        })
    }
